...
public class DBUtil {
    private static final String OracleUser = "hr"; // Use username for Oracle Server
    private static final String OraclePass = "hr"; // Use password for Oracle Server
    private static final String ORACLEURL = "jdbc:oracle:thin:@localhost:1521:xe";

    private static final String MYSQLUser = "root"; //use username for MYSQL Server
    private static final String MYSQLPass = "1955"; // use password for MYSQL Server
