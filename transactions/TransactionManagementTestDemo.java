package com.tolgaduran.jdbc.transactions;
...
create table PSBANK
(
  ACNO   NUMBER(16) default NULL,
  AMOUNT NUMBER     default NULL
)
*/

public class TransactionManagementTestDemo {
    ...
    public static void main(String[] args) throws SQLException{
        ...
        try{
            ...
            if( balanceAmount >= 5000){
                ...
                conn.rollback();
                System.err.println("Insufficient Funds \t\t\t: " + balanceAmount + " Transactions Rollbacked!!!");
            }
